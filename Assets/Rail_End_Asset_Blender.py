...
mesh = bpy.data.meshes.new("Rail_End")
obj  = bpy.data.objects.new("Rail_End", mesh)
...
SCALE = 1   # compensates for Blender FBX 0.01 export scale → correct size in Unity
...
# ── Entry cap (Y=0) — full I-beam N-gon ──────────────────────────────────────
f(e0, e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11)
